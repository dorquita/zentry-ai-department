# Analytics Watcher — 2026-08-16

- **departmentRunId:** `dept-2026-08-16T185140Z`
- **Generado:** 2026-08-16T18:52:00.368Z
- **GA4 conectado:** si
- **GTM conectado:** si
...
## GA4 — Trafico por canal (2026-07-18 a 2026-08-15)
...
| /cerraduras-para-taquillas | 3 | 0 | 33.3% |
...
| `click_phone` | NO | 0 | 0 |
| `click_request_quote` | si | 65 | 65 |
| `click_catalog_download` | si | 3 | 0 |
| `view_quote_page` | si | 12 | 0 |
| `view_contact_page` | si | 38 | 0 |
