# Analytics Watcher — 2026-08-06

- **departmentRunId:** `growth-department-2026-08-06T080051Z`
- **Generado:** 2026-08-06T08:01:26.682Z
- **GA4 conectado:** si
- **GTM conectado:** si
...
## GA4 — Trafico por canal (2026-07-08 a 2026-08-05)
...
| /cerraduras | 2 | 2 | 0.0% |
| /contacto | 2 | 0 | 100.0% |
| /taquillas-para-colegios | 2 | 0 | 100.0% |
...
| `click_phone` | NO | 0 | 0 |
| `click_request_quote` | si | 11 | 11 |
| `click_catalog_download` | si | 3 | 0 |
| `view_quote_page` | si | 2 | 0 |
| `view_contact_page` | si | 12 | 0 |
