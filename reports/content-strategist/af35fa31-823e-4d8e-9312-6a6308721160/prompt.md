# Prompt preparado para content-strategist — changePack af35fa31-823e-4d8e-9312-6a6308721160
...
```json
{
  "changePackId": "af35fa31-823e-4d8e-9312-6a6308721160",
  "workOrderId": "8d024a6d-d0d6-451c-9129-cd608ffceae2",
  "keyword": "hotel",
  ...
  "recommendedTitleHint": "Hotel",
  "primaryKeyword": "hotel",
  "secondaryKeywords": [
    "hoteles"
  ],
  ...
  "brandRationale": "No menciona explicitamente taquilla ni cerradura, pero tiene senales de contexto relevante (sector o material) que sugieren posible interes cruzado. Senal B2B detectada: hotel. Requiere revision manual para decidir Zentry vs Tukandado.",
  ...
  "clusterNote": "Posible cluster SEO con: hoteles. Considerar enlazado interno entre estas paginas.",
  "currentAssumptions": [
    "Se asume que \"hotel\" sigue siendo relevante para Zentry y Tukandado.",
    "Se asume que el brief sigue vigente (no ha cambiado la estrategia de contenido desde que se genero la work order origen)."
  ],
  "risks": [
    "Posible cluster SEO con: hoteles. Considerar enlazado interno entre estas paginas.",
