# Prompt preparado para content-strategist — changePack b25751cb-244b-4faa-8ae9-8f85ceb96d7d
...
```json
{
  "changePackId": "b25751cb-244b-4faa-8ae9-8f85ceb96d7d",
  "workOrderId": "b60e40cd-a27c-4a27-a840-67176bb4b731",
  "keyword": "industrial",
  ...
  "recommendedTitleHint": "Industrial",
  "primaryKeyword": "industrial",
  "secondaryKeywords": [],
  ...
  "brandRationale": "No menciona explicitamente taquilla ni cerradura, pero tiene senales de contexto relevante (sector o material) que sugieren posible interes cruzado. Senal B2B detectada: industrial. Requiere revision manual para decidir Zentry vs Tukandado.",
  ...
  "clusterNote": "No se detectaron otras keywords del backlog para formar cluster todavia.",
  "currentAssumptions": [
    "Se asume que \"industrial\" sigue siendo relevante para Zentry y Tukandado.",
