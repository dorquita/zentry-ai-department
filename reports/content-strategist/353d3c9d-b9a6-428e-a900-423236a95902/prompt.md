# Prompt preparado para content-strategist — changePack 353d3c9d-b9a6-428e-a900-423236a95902
...
```json
{
  "changePackId": "353d3c9d-b9a6-428e-a900-423236a95902",
  "workOrderId": "4aa55874-b42b-42b9-9b15-b0c9be35e811",
  "keyword": "colegio",
  "changeType": "new_content_page",
  "priority": "medium",
  "status": "approved_to_execute",
  "targetBrand": "both",
  "brandIntent": "mixed_cross_sell",
  "contentTypeHint": "Landing nueva",
  "recommendedTitleHint": "Colegio",
  "primaryKeyword": "colegio",
  "secondaryKeywords": [
    "colegios"
  ],
  ...
  "intentHint": "Mixta — puede derivarse a una u otra marca",
  "brandRationale": "No menciona explicitamente taquilla ni cerradura, pero tiene senales de contexto relevante (sector o material) que sugieren posible interes cruzado. Senal B2B detectada: colegio. Requiere revision manual para decidir Zentry vs Tukandado.",
  "recommendedCtaHint": "CTA doble: \"Ver taquillas\" + \"Ver cerraduras\"",
  "internalLinkHints": [
    "Enlazar hacia contenido Zentry (mobiliario)",
    "Enlazar hacia contenido Tukandado (cerradura)"
  ],
  "clusterNote": "Posible cluster SEO con: colegios. Considerar enlazado interno entre estas paginas.",
  "currentAssumptions": [
    "Se asume que \"colegio\" sigue siendo relevante para Zentry y Tukandado.",
    "Se asume que el brief sigue vigente (no ha cambiado la estrategia de contenido desde que se genero la work order origen)."
  ],
  "risks": [
    "Posible cluster SEO con: colegios. Considerar enlazado interno entre estas paginas.",
