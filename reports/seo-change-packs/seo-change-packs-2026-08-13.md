# SEO Change Packs — 2026-08-13

- **departmentRunId:** `growth-department-2026-08-13T080057Z`
- **Generado:** 2026-08-13T08:02:06.886Z

## Resumen ejecutivo

Se crearon **1** change pack(s) SEO nuevo(s) y **16** ya existian (no se duplican). Ningun change pack ejecuta nada: son paquetes de cambio concretos para revision humana, listos para una futura ejecucion controlada que hoy no existe.

## Change packs nuevos (1)

- [medium] `7d3eb4e8-f50b-4bb9-88a9-9bf972f7a93e` fabricante de taquillas fenólicas en badajoz (https://zentrylockers.com/taquillas-fenolicas/) — status: ready_for_review — actualiza borrador existente 2100

## Bloqueadas por el cluster gate (1)
