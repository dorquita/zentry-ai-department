# Staging QA Agent — 2026-08-11

- **departmentRunId:** `growth-department-2026-08-11T080038Z`
- **Generado:** 2026-08-11T08:02:17.077Z
...
Pasan: **20** (de los cuales con warning no bloqueante: **20**). Fallan: **1**.
...
### PASA (con warning) — cerraduras inteligentes para taquillas (`staging-exec-07fd7615-b65e-4ec6-9ad7-5806d5af4505`)

- changeType: seo_on_page_update (criterio de enlaces: no bloqueante)
- wordpressPageId: 2096
- title presente: si | contenido no vacio: si
- enlace interno: no | CTA detectado (heuristica): si | sin <form>: si
- imagen hero: no detectada en este draft.
- QA visual/SEO/CRO (Fase O13.6b): PASA -- botones: 2 | bloques visuales: 4 | CTA above the fold: si | estructura H1/H2: ok | contenido: 1993 caracteres
  - WARNING (no bloqueante): sin enlaces internos reales detectados. Change pack tipo "seo_on_page_update" es un brief/borrador editorial — los enlaces sugeridos de origen son instrucciones para un humano, no URLs reales (quedan como comentario HTML en el contenido del borrador). No cuenta como fallo.

### PASA (con warning) — taquillas melamina (`staging-exec-c4fda091-f9b3-47be-ab1a-4965d85ed36a`)

- changeType: content_update (criterio de enlaces: no bloqueante)
- wordpressPageId: 2097
- title presente: si | contenido no vacio: si
- enlace interno: no | CTA detectado (heuristica): si | sin <form>: si
- imagen hero: no detectada en este draft.
- QA visual/SEO/CRO (Fase O13.6b): PASA -- botones: 3 | bloques visuales: 7 | CTA above the fold: si | estructura H1/H2: ok | contenido: 9390 caracteres
...
- changeType: content_update (criterio de enlaces: no bloqueante)
- wordpressPageId: 2098
- title presente: si | contenido no vacio: si
- enlace interno: no | CTA detectado (heuristica): si | sin <form>: si
- imagen hero: no detectada en este draft.
- QA visual/SEO/CRO (Fase O13.6b): PASA -- botones: 3 | bloques visuales: 7 | CTA above the fold: si | estructura H1/H2: ok | contenido: 9252 caracteres
  - WARNING (no bloqueante): sin enlaces internos reales detectados. Change pack tipo "content_update" es un brief/borrador editorial — los enlaces sugeridos de origen son instrucciones para un humano, no URLs reales (quedan como comentario HTML en el contenido del borrador). No cuenta como fallo.

### PASA (con warning) — taquilla para el personal (`staging-exec-d44a2225-17c8-46c1-8ee7-ebb127f0f133`)

- changeType: content_update (criterio de enlaces: no bloqueante)
- wordpressPageId: 2099
- title presente: si | contenido no vacio: si
- enlace interno: no | CTA detectado (heuristica): si | sin <form>: si
- imagen hero: no detectada en este draft.
- QA visual/SEO/CRO (Fase O13.6b): PASA -- botones: 3 | bloques visuales: 7 | CTA above the fold: si | estructura H1/H2: ok | contenido: 9308 caracteres
  - WARNING (no bloqueante): sin enlaces internos reales detectados. Change pack tipo "content_update" es un brief/borrador editorial — los enlaces sugeridos de origen son instrucciones para un humano, no URLs reales (quedan como comentario HTML en el contenido del borrador). No cuenta como fallo.

### PASA (con warning) — taquillas fenólicas en palencia (`staging-exec-e7a8a1f3-3cdb-494d-8aad-cd0c51a8ca15`)

- changeType: content_update (criterio de enlaces: no bloqueante)
- wordpressPageId: 2100
- title presente: si | contenido no vacio: si
- enlace interno: no | CTA detectado (heuristica): si | sin <form>: si
- imagen hero: no detectada en este draft.
- QA visual/SEO/CRO (Fase O13.6b): PASA -- botones: 3 | bloques visuales: 7 | CTA above the fold: si | estructura H1/H2: ok | contenido: 9194 caracteres
  - WARNING (no bloqueante): sin enlaces internos reales detectados. Change pack tipo "content_update" es un brief/borrador editorial — los enlaces sugeridos de origen son instrucciones para un humano, no URLs reales (quedan como comentario HTML en el contenido del borrador). No cuenta como fallo.

### PASA (con warning) — comprar taquillas (`staging-exec-2f46e83d-91af-40f3-8b9e-16bd1c4857fe`)

- changeType: content_update (criterio de enlaces: no bloqueante)
- wordpressPageId: 2101
- title presente: si | contenido no vacio: si
- enlace interno: no | CTA detectado (heuristica): si | sin <form>: si
- imagen hero: no detectada en este draft.
- QA visual/SEO/CRO (Fase O13.6b): PASA -- botones: 3 | bloques visuales: 7 | CTA above the fold: si | estructura H1/H2: ok | contenido: 9217 caracteres
  - WARNING (no bloqueante): sin enlaces internos reales detectados. Change pack tipo "content_update" es un brief/borrador editorial — los enlaces sugeridos de origen son instrucciones para un humano, no URLs reales (quedan como comentario HTML en el contenido del borrador). No cuenta como fallo.

### PASA (con warning) — soluciones de taquillas (`staging-exec-b49f61a0-0086-4aa7-8965-ecd42b26ffbf`)

- changeType: content_update (criterio de enlaces: no bloqueante)
- wordpressPageId: 2102
- title presente: si | contenido no vacio: si
- enlace interno: no | CTA detectado (heuristica): si | sin <form>: si
- imagen hero: no detectada en este draft.
- QA visual/SEO/CRO (Fase O13.6b): PASA -- botones: 3 | bloques visuales: 7 | CTA above the fold: si | estructura H1/H2: ok | contenido: 9277 caracteres
  - WARNING (no bloqueante): sin enlaces internos reales detectados. Change pack tipo "content_update" es un brief/borrador editorial — los enlaces sugeridos de origen son instrucciones para un humano, no URLs reales (quedan como comentario HTML en el contenido del borrador). No cuenta como fallo.

### FALLA — taquillas inteligentes (`staging-exec-8e883a38-2f71-4aee-9cb1-f4af6a1f67b4`)

- changeType: content_update (criterio de enlaces: no bloqueante)
- wordpressPageId: 2103
- title presente: si | contenido no vacio: si
- enlace interno: no | CTA detectado (heuristica): si | sin <form>: si
- imagen hero: no detectada en este draft.
- QA visual/SEO/CRO (Fase O13.6b): PASA -- botones: 2 | bloques visuales: 6 | CTA above the fold: si | estructura H1/H2: ok | contenido: 9593 caracteres
  - WARNING (no bloqueante): sin enlaces internos reales detectados. Change pack tipo "content_update" es un brief/borrador editorial — los enlaces sugeridos de origen son instrucciones para un humano, no URLs reales (quedan como comentario HTML en el contenido del borrador). No cuenta como fallo.
  - Estado actual en WordPress: "publish" (se esperaba "draft").

### PASA (con warning) — taquillas para vestuarios (`staging-exec-0733cfbe-55fd-47b8-a148-8a130b4a8d51`)

- changeType: content_update (criterio de enlaces: no bloqueante)
- wordpressPageId: 2104
- title presente: si | contenido no vacio: si
- enlace interno: no | CTA detectado (heuristica): si | sin <form>: si
- imagen hero: no detectada en este draft.
- QA visual/SEO/CRO (Fase O13.6b): PASA -- botones: 3 | bloques visuales: 7 | CTA above the fold: si | estructura H1/H2: ok | contenido: 9297 caracteres
  - WARNING (no bloqueante): sin enlaces internos reales detectados. Change pack tipo "content_update" es un brief/borrador editorial — los enlaces sugeridos de origen son instrucciones para un humano, no URLs reales (quedan como comentario HTML en el contenido del borrador). No cuenta como fallo.

### PASA (con warning) — metalicas taquillas (`staging-exec-81f40942-968f-41ca-a4b1-365d9d1f81a4`)

- changeType: content_update (criterio de enlaces: no bloqueante)
- wordpressPageId: 2105
- title presente: si | contenido no vacio: si
- enlace interno: no | CTA detectado (heuristica): si | sin <form>: si
- imagen hero: no detectada en este draft.
- QA visual/SEO/CRO (Fase O13.6b): PASA -- botones: 3 | bloques visuales: 7 | CTA above the fold: si | estructura H1/H2: ok | contenido: 9100 caracteres
  - WARNING (no bloqueante): sin enlaces internos reales detectados. Change pack tipo "content_update" es un brief/borrador editorial — los enlaces sugeridos de origen son instrucciones para un humano, no URLs reales (quedan como comentario HTML en el contenido del borrador). No cuenta como fallo.
...
- enlace interno: no | CTA detectado (heuristica): si | sin <form>: si
- imagen hero: no detectada en este draft.
- QA visual/SEO/CRO (Fase O13.6b): PASA -- botones: 3 | bloques visuales: 7 | CTA above the fold: si | estructura H1/H2: ok | contenido: 8203 caracteres
  - WARNING (no bloqueante): sin enlaces internos reales detectados. Change pack tipo "content_update" es un brief/borrador editorial — los enlaces sugeridos de origen son instrucciones para un humano, no URLs reales (quedan como comentario HTML en el contenido del borrador). No cuenta como fallo.

### PASA (con warning) — industrial (`staging-exec-7f09cea0-a09a-41a9-9264-7c293fe265b3`)

- changeType: new_content_page (criterio de enlaces: no bloqueante)
- wordpressPageId: 2107
- title presente: si | contenido no vacio: si
- enlace interno: no | CTA detectado (heuristica): si | sin <form>: si
- imagen hero: no detectada en este draft.
- QA visual/SEO/CRO (Fase O13.6b): PASA -- botones: 3 | bloques visuales: 7 | CTA above the fold: si | estructura H1/H2: ok | contenido: 8031 caracteres
...
- changeType: new_content_page (criterio de enlaces: no bloqueante)
- wordpressPageId: 2108
- title presente: si | contenido no vacio: si
- enlace interno: no | CTA detectado (heuristica): si | sin <form>: si
- imagen hero: no detectada en este draft.
- QA visual/SEO/CRO (Fase O13.6b): PASA -- botones: 3 | bloques visuales: 7 | CTA above the fold: si | estructura H1/H2: ok | contenido: 8007 caracteres
  - WARNING (no bloqueante): sin enlaces internos reales detectados. Change pack tipo "new_content_page" es un brief/borrador editorial — los enlaces sugeridos de origen son instrucciones para un humano, no URLs reales (quedan como comentario HTML en el contenido del borrador). No cuenta como fallo.

### PASA (con warning) — colegio (`staging-exec-e7426c46-9592-4ab6-bc60-5c417f89efcf`)

- changeType: new_content_page (criterio de enlaces: no bloqueante)
- wordpressPageId: 2109
- title presente: si | contenido no vacio: si
- enlace interno: no | CTA detectado (heuristica): si | sin <form>: si
- imagen hero: no detectada en este draft.
- QA visual/SEO/CRO (Fase O13.6b): PASA -- botones: 3 | bloques visuales: 7 | CTA above the fold: si | estructura H1/H2: ok | contenido: 8007 caracteres
...
- changeType: new_content_page (criterio de enlaces: no bloqueante)
- wordpressPageId: 2110
- title presente: si | contenido no vacio: si
- enlace interno: no | CTA detectado (heuristica): si | sin <form>: si
- imagen hero: no detectada en este draft.
- QA visual/SEO/CRO (Fase O13.6b): PASA -- botones: 3 | bloques visuales: 7 | CTA above the fold: si | estructura H1/H2: ok | contenido: 8039 caracteres
  - WARNING (no bloqueante): sin enlaces internos reales detectados. Change pack tipo "new_content_page" es un brief/borrador editorial — los enlaces sugeridos de origen son instrucciones para un humano, no URLs reales (quedan como comentario HTML en el contenido del borrador). No cuenta como fallo.

### PASA (con warning) — hotel (`staging-exec-192fd8b2-359f-4922-81ac-ba13e90b298f`)

- changeType: new_content_page (criterio de enlaces: no bloqueante)
- wordpressPageId: 2111
- title presente: si | contenido no vacio: si
- enlace interno: no | CTA detectado (heuristica): si | sin <form>: si
- imagen hero: no detectada en este draft.
- QA visual/SEO/CRO (Fase O13.6b): PASA -- botones: 3 | bloques visuales: 7 | CTA above the fold: si | estructura H1/H2: ok | contenido: 7991 caracteres
  - WARNING (no bloqueante): sin enlaces internos reales detectados. Change pack tipo "new_content_page" es un brief/borrador editorial — los enlaces sugeridos de origen son instrucciones para un humano, no URLs reales (quedan como comentario HTML en el contenido del borrador). No cuenta como fallo.
