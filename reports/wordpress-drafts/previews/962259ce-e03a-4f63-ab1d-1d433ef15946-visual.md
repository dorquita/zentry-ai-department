# Preview VISUAL (local, no publicado) — hoteles
...
> Este fichero es un preview VISUAL local (Fase O12.4), complementario al preview de texto ya generado por el WordPress Draft Agent (`962259ce-e03a-4f63-ab1d-1d433ef15946.md`, sin tocar). No se ha llamado a WordPress ni generado ninguna imagen real.
