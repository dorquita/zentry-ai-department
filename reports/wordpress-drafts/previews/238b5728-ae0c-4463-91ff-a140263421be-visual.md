# Preview VISUAL (local, no publicado) — oficinas

- **draftId:** `238b5728-ae0c-4463-91ff-a140263421be`
- **changePackId:** `737ca8d9-5031-4890-a528-bf7e7b8f6029` (status: ready_for_review)
...
> Este fichero es un preview VISUAL local (Fase O12.4), complementario al preview de texto ya generado por el WordPress Draft Agent (`238b5728-ae0c-4463-91ff-a140263421be.md`, sin tocar). No se ha llamado a WordPress ni generado ninguna imagen real.
