# Preview VISUAL (local, no publicado) — colegio

- **draftId:** `0977d555-982e-4a3e-9364-89e8102a57e9`
- **changePackId:** `353d3c9d-b9a6-428e-a900-423236a95902` (status: approved_to_execute)
...
> Este fichero es un preview VISUAL local (Fase O12.4), complementario al preview de texto ya generado por el WordPress Draft Agent (`0977d555-982e-4a3e-9364-89e8102a57e9.md`, sin tocar). No se ha llamado a WordPress ni generado ninguna imagen real.
...
(brief de contenido, no copy final) Posible cluster SEO con: colegios. Considerar enlazado interno entre estas paginas.
