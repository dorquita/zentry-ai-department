# Preview VISUAL (local, no publicado) — colegios
...
> Este fichero es un preview VISUAL local (Fase O12.4), complementario al preview de texto ya generado por el WordPress Draft Agent (`fbbd6e15-0c5d-4e28-8713-15c9b04341f7.md`, sin tocar). No se ha llamado a WordPress ni generado ninguna imagen real.
