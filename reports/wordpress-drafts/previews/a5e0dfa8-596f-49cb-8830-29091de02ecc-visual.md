# Preview VISUAL (local, no publicado) — fenolico
...
> Este fichero es un preview VISUAL local (Fase O12.4), complementario al preview de texto ya generado por el WordPress Draft Agent (`a5e0dfa8-596f-49cb-8830-29091de02ecc.md`, sin tocar). No se ha llamado a WordPress ni generado ninguna imagen real.
