# Preview VISUAL (local, no publicado) — para vestuarios
...
> Este fichero es un preview VISUAL local (Fase O12.4), complementario al preview de texto ya generado por el WordPress Draft Agent (`d798c8f3-feb5-4284-ae5e-1f60921e7f14.md`, sin tocar). No se ha llamado a WordPress ni generado ninguna imagen real.
