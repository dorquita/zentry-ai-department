# Preview VISUAL (local, no publicado) — cerradura para cada
...
> Este fichero es un preview VISUAL local (Fase O12.4), complementario al preview de texto ya generado por el WordPress Draft Agent (`dd3e4135-e18e-4ad6-911d-6228d7967f6f.md`, sin tocar). No se ha llamado a WordPress ni generado ninguna imagen real.
