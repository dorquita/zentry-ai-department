...
async function main() {
  ...
  console.log("  30cm=194€:", c2.variations.some((v) => v.attributes.some((a) => a.value === "30cm") && v.prices.price === "19400"));
  console.log("  40cm=239€:", c2.variations.some((v) => v.attributes.some((a) => a.value === "40cm") && v.prices.price === "23900"));
