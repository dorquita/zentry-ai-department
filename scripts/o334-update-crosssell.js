...
const code = [
  ...
  "            <p class=\"zentry-lock-crosssell__title\">&iquest;Dudas sobre qu&eacute; cerradura elegir?</p>",
  "            <p class=\"zentry-lock-crosssell__text\">Tambi&eacute;n puedes consultar las cerraduras disponibles y elegir la opci&oacute;n m&aacute;s adecuada para tu proyecto.</p>",
  "        </div>",
...
fetch(base + "/wp-json/code-snippets/v1/snippets/16", {
  ...
  .then(async (r) => {
    ...
    console.log("STATUS", r.status, "code_error:", j.code_error, "active:", j.active);
  })
